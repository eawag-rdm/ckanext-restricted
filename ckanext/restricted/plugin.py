...
from ckan.logic import NotFound, get_or_bust, side_effect_free
...
def restricted_check_user_resource_access(
    user: str, resource_dict: dict, package_dict: dict
):
    ...
    try:
        ...
        allowed_users = json.loads(resource_dict.get("allowed_users", "[]"))
...
def restricted_resource_show(context, data_dict=None):
    ...
    user_name = ""
    if auth_user_obj and hasattr(auth_user_obj, 'as_dict'):
